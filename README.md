...
真实语音转写与 AI 整理使用阿里云百炼。请在 App 内的“配置 API Key”中填写自己的个人 Key；密钥保存在设备安全存储中，不提交到 GitHub。
...
- **界面规范**：17pt 正文、44pt 最小触控区、56pt 语音主按钮、统一 Ionicons / Lucide SVG 图标和 Dynamic Type 增长空间；品牌绿色保持不变。
